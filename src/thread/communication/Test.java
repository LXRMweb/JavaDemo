 ...
 * 		程序功能：利用两个线程，对一个整型成员变量进行变化，一个使其增加，另一个线程使其减小，利用线程之间的通信，实现该整型变量0101这样的交替变更
...
public class Test {
	public static void main(String[] args){
		NumberHolder numberHolder=new NumberHolder();//获得一个类对象
		//以同一个类对象开启两个线程，这样这两个线程就会共享该"类对象"
